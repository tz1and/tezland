...
admin_mixin = sp.io.import_script_from_url("file:contracts/Fees.py")

class FeesTest(admin_mixin.Fees, sp.Contract):
    def __init__(self, administrator):
        admin_mixin.Fees.__init__(self, administrator = administrator)
