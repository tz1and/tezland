...
fa2_contract.add_test(fa2_contract.FA2_config(store_total_supply = False, royalties = True, allow_burn_tokens = True, operator_burn = True))
fa2_contract.add_test(fa2_contract.FA2_config(store_total_supply = True, allow_burn_tokens = True, operator_burn = True))
fa2_contract.add_test(fa2_contract.FA2_config(store_total_supply = True, royalties = True, allow_burn_tokens = True, operator_burn = True))
