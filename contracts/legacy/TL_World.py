...
from contracts.legacy.mixins.Fees import Fees
        ...
        with item_store[params.item_id].match_cases() as arg:
            ...
            with arg.match("item") as immutable:
                ...
                with sp.if_(the_item.value.mutez_per_item != sp.tez(0)):
                    ...
                    item_royalty_info = sp.compute(FA2_legacy.getRoyalties(self.data.items_contract, the_item.value.token_id).open_some())
